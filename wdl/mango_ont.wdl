...
# MANGO-ONT — trio methylation DMR for Oxford Nanopore (Dorado) modBAMs.
# Forces --platform ont: optimized CpG workers + --combine-strands.
...
workflow mango_ont {
  ...
  call mango.run_mango {
    input:
      ...
      platform = "ont", combine_strands = true,
  ...
  meta {
    description: "MANGO-ONT: trio methylation DMR for Oxford Nanopore Dorado modBAMs (AnVIL/Terra)."
    author: "MANGO"
  }
}
